...
$stmt = $conn->prepare("SELECT * FROM device_category WHERE company_code = ? ORDER BY category_code DESC");
...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">List Category</h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="card-header align-center">
                                    <a href="admin/categories/create">
                                        <button type="button" class="btn btn-primary btn-block"
                                            ...
                                            <i class="fas fa-plus" style="margin-right: 8px;"></i>Create Category
                                        </button>
                                    </a>
                                </div>
                                        ...
                                        <table id="tableCategories"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center lebar-kolom2">Name_Category</th>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ?>
                                                        <tr>
                                                            <td class="text-center"><?php echo $row['category_code']; ?></td>
                                                            <td class="text-center"><?php echo $row['description']; ?></td>
                                                            <td class="text-center">
                                                                <a href="admin/categories/edit?category_id=<?php echo $row['category_id']; ?>"
                                                                    class="btn btn-info btn-sm">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                <a href="admin/device/list?category_id=<?php echo $row['category_id']; ?>"
    ...
    <script>
        $(document).ready(function () {
            $('#tableCategories').on('click', '.delete-btn', function (e) {
                e.preventDefault();
