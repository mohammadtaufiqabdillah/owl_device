...
if (!$company_code) {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            swal({
                title: 'Tidak Bisa Membuat Command Exe!',
...
<head>
    ...
    <title>Create Command Exe</title>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-center justify-content-between pt-2 pb-4">
                        <h3 class="fw-bold mb-3">Create Command Exe</h3>
                    </div>
                    <div class="card card-round">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Add Command Exe Data</h4>
                        </div>
                        <form method="POST">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="nameCommandExe">Command Name</label>
                                    <input type="text" class="form-control form-control-border border-width-2"
                                        id="nameCommandExe" name="nameCommandExe" placeholder="Enter command name"
                                        required>
                                </div>
                                <div class="form-group">
