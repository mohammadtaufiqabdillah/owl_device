...
$stmt->execute();
$command_set = $stmt->get_result()->fetch_assoc();
...
$setName = $command_set['command_name'];
...
<head>
    ...
    <title>Command Set Detail</title>
...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">set :: <?= $setName ?></h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-round">
                                <div class="card-header align-center">
                                    <a href="admin/command/set/detail/create?command_id=<?= $command_id ?>">
                                    ...
                                    <button type="button" class="btn btn-secondary"
                                        onclick="window.location.href='admin/command/set/list'">Back</button>
                                </div>
                                <div class="card-body p-0">
                                    <div class="table-responsive card-padding">
                                        <table id="tableCommandSetDetail"
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="admin/command/set/detail/edit?command_id=<?= $command_id ?>&command_detail_id=<?= $row['command_detail_id'] ?>"
    ...
    <script>
        $(document).ready(function () {
            $('#tableCommandSetDetail').on('click', '.delete-btn', function (e) {
                e.preventDefault();
                ...
                swal({
                    ...
                    $.ajax({
                        url: 'admin/command/set/detail/list?command_id=<?= $command_id ?>',
                        type: 'POST',
                        ...
                        success: function (res) {
                            if (res.status === "success") {
                                swal({
                                    ...
                                    window.location.replace("/owl_device/admin/command/set/detail/list?command_id=<?= $command_id ?>");
                                });
                            } else {
                                swal({
                                    icon: "error",
