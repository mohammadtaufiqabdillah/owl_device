...
$command_dat = $result->fetch_assoc();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $original_name = $command_dat['command_name'];
        ...
        echo "
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    swal({
                        title: 'Berhasil!',
                        text: 'Command Dat berhasil diperbarui.',
                        icon: 'success',
                        buttons: false,
                        timer: 1200
                    }).then(() => {
                        window.location.href = './admin/command/dat/list';
                    });
                });
            </script>";
    } else {
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-center justify-content-between pt-2 pb-4">
                        <h3 class="fw-bold mb-3">Edit Command Dat</h3>
                    </div>
                    <div class="card card-round">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Edit Command Dat Data</h4>
                        </div>
                        <form method="POST">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border border-width-2"
                                        ...
                                        value="<?= htmlspecialchars($command_dat['command_name']); ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border border-width-2"
                                        ...
                                        value="<?= htmlspecialchars($command_dat['custom_class']); ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border border-width-2"
                                        ...
                                        value="<?= htmlspecialchars($command_dat['description']); ?>">
                                </div>
                                <div class="form-group">
